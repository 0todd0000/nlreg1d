...
nl.plot.plot_multipanel(y, yr, d, J, colors, parametric, ylim, alpha_x, paired=False, permutations=nperm, dvlabel='Muscle force  (kN)', group_labels=['Control mean', 'PFP mean'], xlabel=xlabel, leg_loc=leg_loc)
plt.show()
if save:
